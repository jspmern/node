...
function Nav() {
    return (
        <>
            ...
            w-full sticky z-20 top-0 left-0 border-b border-gray-200  dark:border-gray-600 
            flex justify-between items-center'>
                <div className=' text-blue-500 text-3xl font-bold p-4'>
                    JS HEAVEN
                </div>
                <div className=' hidden justify-evenly w-6/12 text-blue-500 text-lg font-mono 
                md:flex'>
                    <NavLink to="/" exact activeClassName="active"><li className="list-none">HOME</li></NavLink>
                    <NavLink to="/products" activeClassName="active"><li className="list-none">PRODUCTS</li></NavLink>
